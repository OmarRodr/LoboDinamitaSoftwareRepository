 ...
 * @author ulise
 */
public class DetallesMus extends javax.swing.JFrame {

    /**
     * Creates new form DetallesMus
     */
    public DetallesMus() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int v = JOptionPane.showConfirmDialog(this, "Estas seguro que deseas salir","Advertencia",JOptionPane.YES_NO_OPTION);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DetallesMus.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DetallesMus().setVisible(true);
            }
        });
    }
